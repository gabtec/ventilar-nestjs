...
export class schemaSync1678207518590 implements MigrationInterface {
  name = 'schemaSync1678207518590';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "t_ventilators" ("id" SERIAL NOT NULL, "brand" character varying NOT NULL, "model" character varying NOT NULL, "serial" character varying NOT NULL, "category" character varying(4) NOT NULL, "is_free" boolean NOT NULL DEFAULT true, "park_id" integer NOT NULL, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_5151ad9b964ba81234a6cc4d9a7" UNIQUE ("serial"), CONSTRAINT "PK_6e09e4482737f0d2a4087eac5bd" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
