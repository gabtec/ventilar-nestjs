...
describe('Wards', () => {
  ...
  describe.only('Test Routes with AuthGuard OFF', () => {
    ...
    describe('POST /api/wards', () => {
      ...
      it('should return 400| BadRequest, if createDto without "institution" prop', () => {
        return request(app.getHttpServer())
          .post('/api/wards/')
      ...
      it('should return 201| Created, if valid createDto', () => {
        return request(app.getHttpServer())
          .post('/api/wards/')
          .send({ name: 'HDP_Medicina', institution: 'HDP' })
          .expect(201);
      });
    });
    ...
    describe('GET /api/wards', () => {
      const url = '/api/wards/';
      it('should get an Array with a list of wards, each one with this props: {id:int, name: str, institution: str, created_at and updated_at timestamps}', () => {
